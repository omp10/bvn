...
export const IconEye = (p: P) => <Icon {...p} d="M2 12s3.6-7 10-7 10 7 10 7-3.6 7-10 7-10-7-10-7zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />;
export const IconEyeOff = (p: P) => <Icon {...p} d="M10.6 6.2A9.8 9.8 0 0 1 12 6c6.4 0 10 6 10 6a17.6 17.6 0 0 1-3.4 4.1M6.5 7.6A17.4 17.4 0 0 0 2 12s3.6 6 10 6c1.7 0 3.2-.4 4.5-1M3 3l18 18M9.9 10a3 3 0 0 0 4.2 4.2" />;
